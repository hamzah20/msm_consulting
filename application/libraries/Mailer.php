...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'webmail@aimandiri.id'; // Isikan dengan email pengirim
    protected $nama_pengirim = ''; // Isikan dengan nama pengirim
    protected $password = 'email_webmail'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->Host = 'smtp.mail.aimandiri.id';
