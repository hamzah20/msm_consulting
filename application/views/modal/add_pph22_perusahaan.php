  	<div class="modal fade" id="addPPH22Perusahaan" tabindex="-1" aria-labelledby="addPPH22Perusahaan" aria-hidden="true">
  		<div class="modal-dialog">
  			<form class="needs-validation" id="formAddCompany" method="POST" novalidate action="<?= base_url('PPH/Pph22/addCompany'); ?>">
  				<div class="modal-content">
  					<div class="modal-header">
  						<h5 class="modal-title" id="addPPH22Perusahaan">Tambah Periode - PPH 22</h5>
