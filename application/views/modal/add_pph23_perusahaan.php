  	<div class="modal fade" id="addPPH23Perusahaan" tabindex="-1" aria-labelledby="addPPH23Perusahaan" aria-hidden="true">
  		<div class="modal-dialog">
  			<form class="needs-validation" id="formAddCompany" method="POST" novalidate action="<?= base_url('PPH/Pph23/addCompany'); ?>">
  				<div class="modal-content">
  					<div class="modal-header">
  						<h5 class="modal-title" id="addPPH23Perusahaan">Tambah Periode - PPH 23</h5>
