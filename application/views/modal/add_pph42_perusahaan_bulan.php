  	<div class="modal fade" id="addPPH42PerusahaanBulan" tabindex="-1" aria-labelledby="addPPH42PerusahaanBulan" aria-hidden="true">
  	  <div class="modal-dialog">
  	    <form class="needs-validation" id="formAddCompany" method="POST" novalidate action="<?= base_url('PPH/Pph42/addCompany'); ?>">
  	      <div class="modal-content">
  	        <div class="modal-header">
  	          <h5 class="modal-title" id="addPPH42PerusahaanBulan">Tambah Periode - PPH 21</h5>
