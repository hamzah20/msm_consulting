  	<div class="modal fade" id="addPPH42Perusahaan" tabindex="-1" aria-labelledby="addPPH42Perusahaan" aria-hidden="true">
  		<div class="modal-dialog">
  			<form class="needs-validation" id="formAddCompany" method="POST" novalidate action="<?= base_url('PPH/Pph42/addCompany'); ?>">
  				<div class="modal-content">
  					<div class="modal-header">
  						<h5 class="modal-title" id="addPPH42Perusahaan">Tambah Periode - PPH 42</h5>
