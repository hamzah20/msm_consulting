  	<div class="modal fade" id="addPPH21Perusahaan" tabindex="-1" aria-labelledby="addPPH21Perusahaan" aria-hidden="true">
  		<div class="modal-dialog">
  			<form class="needs-validation" id="formAddCompany" method="POST" novalidate action="<?= base_url('PPH/Pph21/addCompany'); ?>">
  				<div class="modal-content">
  					<div class="modal-header">
  						<h5 class="modal-title" id="addPPH21Perusahaan">Tambah Periode - PPH 21</h5>
                      ...
                      <option value="2021">2021</option>
  						...
  						<input type="hidden" name="pphFlag" id="pphFlag" value="false">
