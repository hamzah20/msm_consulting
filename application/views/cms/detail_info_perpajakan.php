        ...
        <div class="content mt-3">      
           <div class="card px-2"> 
       			<ul class="nav nav-tabs nav-edit-perusahaan m-2 mt-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url('Client/detail_info_perpajakan') ?>"><i class="fa fa-info-circle mr-1"></i>Info Perpajakan</a>
                    </li>
                    <li class="nav-item">
                ...
                <a class="btn btn-sm btn-warning col-2 ml-2 mb-3 mt-1 text-white" type="submit" href="<?php echo base_url('Client/edit_info_perpajakan'); ?>">Edit Data</a>
                <hr class="mx-2 mt-0">
