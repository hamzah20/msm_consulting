    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">      
           <div class="card px-2 pt-3">    
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="" aria-describedby="" value="PRF2108-00001" readonly> 
                            </div>
                        </div>
                    </div> 
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="" aria-describedby="" value="KPP" readonly> 
                            </div>
                            <div class="form-group">
                ...
                <hr class="mx-2">
                <div class="row ml-2">
                    <button class="btn btn-sm btn-success col-2 ml-2 mb-3" type="submit">Simpan Data</button>
