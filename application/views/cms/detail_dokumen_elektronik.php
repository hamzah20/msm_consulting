                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active"> <a href="<?php echo base_url('company_profile'); ?>">Profil Perusahaan</a> / Detail Dokumen Elektronik</li>
                        </ol>
                    </div>
                </div>
            </div>
           ...
           <div class="card px-2"> 
                  ...
                  <li class="nav-item">
                      ...
                      <a class="nav-link" href="<?php echo base_url('company_profile/detail/identitas_pj'); ?>"><i class="fa fa-id-badge mr-1"></i>Identitas Penanggung Jawab</a>
                          ...
                          <li class="nav-item">
                      <a class="nav-link active" href="<?php echo base_url('company_profile/detail/dokumen_elektronik'); ?>"><i class="fa fa-file mr-1"></i>Dokumen Elektronik</a>
                  </li>
                </ul> 
              <a class="btn btn-sm btn-warning col-2 ml-2 mb-3 mt-1 text-white" type="submit" href="<?php echo base_url('company_profile/edit/dokumen_elektronik'); ?>">Edit Data</a>
              <hr class="mx-2 mt-0">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="custom-file pt-1">
                                <input type="text" class="form-control form-control-sm" id="" aria-describedby="" readonly placeholder="File sudah diupload"> 
                              </div> 
                            </div>
                        </div> 
                        <div class="form-group">
