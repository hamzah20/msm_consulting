    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">      
           <div class="card px-2"> 
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo base_url('Client/detail_dokumen_elektronik'); ?>"><i class="fa fa-file mr-1"></i>Dokumen Elektronik</a>
                </li>
      				</ul> 
              <a class="btn btn-sm btn-warning col-2 ml-2 mb-3 mt-1 text-white" type="submit" href="<?php echo base_url('Client/edit_dokumen_elektronik'); ?>">Edit Data</a>
              <hr class="mx-2 mt-0">
