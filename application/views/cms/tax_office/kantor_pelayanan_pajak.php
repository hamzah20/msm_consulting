                      ...
                      <?php foreach ($companies->result() as $tax) { ?>
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-danger hapus" data-toggle="tooltip" data-placement="top" data-id="<?= $tax->OFFICE_ID; ?>" title="Hapus" href="#" role="button">
    ...
    $(document).on('click', '.hapus', function(event) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          $.post(baseUrl + 'General/Tax_office/delete_kantor_pelayanan_pajak', {
            officeID: officeID
          }, function(resp) {
            if (resp.code == 200) {
              Swal.fire({
