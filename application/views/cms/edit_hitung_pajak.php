                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active"> <a href="<?php echo base_url('company_profile'); ?>">Company Profile</a> / Edit Hitung Pajak</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">      
           <div class="card px-2"> 
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="<?php echo base_url('company_profile/edit/hitung_pajak'); ?>"><i class="fa fa-calculator mr-1"></i>Hitung Pajak</a>
                </li>
                <li class="nav-item">
