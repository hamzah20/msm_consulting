      ...
      <div class="page-header float-right">
        <div class="page-title">
          <ol class="breadcrumb text-right">
            <li class="active"> <a href="<?php echo base_url('pph_22'); ?>"> PPh 23</a> / PPh 23 Bulanan</li>
          </ol>
        </div>
      </div>
    </div>
              ...
              <?php foreach ($correction->result() as $company) { ?>
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Approve" href="<?= base_url('pph_23/bulan/approve?pid=' . $company->PPH23_ID . '&cid=' . $company->COMPANY_ID . '&mid=' . $company->PERIOD_MONTH . '&yid=' . $company->PERIOD_YEAR); ?>"><i class="fa fa-check-circle"></i></a>
                  </td>
                </tr>
              <?php } ?>
            <?php } ?>
