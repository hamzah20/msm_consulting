      ...
      <div class="page-header float-right">
        <div class="page-title">
          <ol class="breadcrumb text-right">
            <li class="active"> <a href="<?php echo base_url('pph_42'); ?>"> PPh 4(2)</a> / <a href="<?php echo base_url('pph_42/bulan?cid=' . $this->input->get('cid')) ?>">Bulanan</a> / Summary</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="card mt-3">
      <div class="card-body">
        <ul class="nav nav-tabs nav-edit-perusahaan my-3">
          <li class="nav-item">
              <a class="nav-link" href="<?= base_url('pph_42/bulan/summary?cid=' . $employee->COMPANY_ID . '&pid=' . $employee->PPH42_ID . '&mid=' . $employee->PERIOD_MONTH . '&yid=' . $employee->PERIOD_YEAR); ?>"><i class="fa fa-id-card mr-1"></i>PPH 4(2)</a>
          </li>
          <li class="nav-item">
              <a class="nav-link active" href="<?= base_url('pph_42/bulan/summary/umkm?cid=' . $employee->COMPANY_ID . '&pid=' . $employee->PPH42_ID . '&mid=' . $employee->PERIOD_MONTH . '&yid=' . $employee->PERIOD_YEAR); ?>"><i class="fa fa-id-card mr-1"></i>UMKM</a>
          </li> 
          </li>
        </ul>
        <div class="row">
          <div class="col-6">
            ...
            <a class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Download" href="<?= base_url('PPH/Pph42/generateXLSFileUMKM?pid=' . $this->input->get('pid') . '&cid=' . $this->input->get('cid')); ?>"><i class="fa fa-download"></i> Download</a>
           
            <a class="btn btn-sm btn-danger" href="#" role="button" data-toggle="modal" title="Import" data-target="#importUMKM"><i class="fa fa-upload"></i> Upload</a> 
        ...
        <a class="btn btn-sm btn-info" title="Tambah" href="<?= base_url('pph_42/transaksi/umkm/add?pid='.$employee->PPH42_ID.'&cid='.$employee->COMPANY_ID ); ?>"><i class="fa fa-plus"></i> Transaksi</a>

        <table id="companyUMKMTable" class="table table-company">
          <!-- <thead class="thead-dark"> -->
            <tr class="thead-dark">
              <th scope="col-">No</th>
              <th scope="col-">UMKM Nama</th> 
              <th scope="col-">UMKM NPWP</th>
              <th scope="col-">Bruto</th> 
              <th scope="col-">PPH UMKM</th> 
          ...
          <tbody>
            ...
            ?>
              ...
              foreach ($employees->result() as $employee) {   
                ...
                <tr>
                  <td><?= $counter++; ?></td>
                  <td><?= $employee->UMKM_NAMA; ?></td> 
                  <td><?= $employee->UMKM_NPWP; ?></td>
                  <td><?= $employee->UMKM_BRUTO; ?></td> 
                  <!-- <td><?= number_format($employee->TOTAL_PPHVAL22); ?></td> -->
                  <td><?= $employee->UMKM_TOTAL_PPHVAL42; ?></td>
                  ...
                  <td>
                    ...
                    <a class="btn btn-sm btn-warning text-white" data-toggle="tooltip" data-placement="top" title="Edit" href="<?= base_url('pph_42/bulan/summary/karyawan/umkm/edit?eid=' . $employee->INCOME_ID . '&cid=' . $employee->COMPANY_ID . '&pid=' . $employee->PPH42_ID. '&mid=' . $employee->PERIOD_MONTH. '&yid=' . $employee->PERIOD_YEAR); ?>"><i class="fa fa-edit"></i></a>
                  </td>
                </tr>
              <?php } ?>  
            <?php } ?>
