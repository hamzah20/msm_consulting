            ...
            <div class="col-4">
              ...
              <div class="form-group">
                ...
                <div class="row mb-2">
                  <div class="col-6">
                    Tunjangan (1)
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_TUNJANGAN_1); ?>" name="editTunjangan1">
                  </div>
                  <div class="col-6">
                    Tunjangan (2)
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_TUNJANGAN_2); ?>" name="editTunjangan2">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-6">
                    Tunjangan (3)
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_TUNJANGAN_3); ?>" name="editTunjangan3">
                  </div>
                  <div class="col-6">
                    Tunjangan (4)
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_TUNJANGAN_4); ?>" name="editTunjangan4">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-6">
                    Tunjangan (5)
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_TUNJANGAN_5); ?>" name="editTunjangan5">
                  </div>
                  <div class="col-6">
                    Tunjangan (6)
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_TUNJANGAN_6); ?>" name="editTunjangan6">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-6">
                    Tunjangan (7)
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_TUNJANGAN_7); ?>" name="editTunjangan7">
                  </div>
                  <div class="col-6">
                    Tunjangan (8)
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_TUNJANGAN_8); ?>" name="editTunjangan8">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-6">
                    Tunjangan (9)
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_TUNJANGAN_9); ?>" name="editTunjangan9">
                  </div>
                  <div class="col-6">
                    Tunjangan (10)
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_TUNJANGAN_10); ?>" name="editTunjangan10">
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="row mb-2">
                  <div class="col-6">
                    JKK :
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_PREMI_JKK); ?>" name="editJKK">
                  </div>
                  <div class="col-6">
                    JKM :
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_PREMI_JKM); ?>" name="editJKM">
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-6">
                    BPJS :
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_PREMI_BPJS); ?>" name="editBPJS">
                  </div> 
                </div>
            ...
            <div class="col-4">
              ...
              <div class="form-group">
                ...
                <div class="row mb-2">
                  <div class="col-6">
                    Iuran JHT/THT
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_IURAN_THT); ?>" name="editJHT">
                  </div>
                  <div class="col-6">
                    Iuran JP
                    <input type="text" class="form-control form-control-sm" value="<?= number_format($employee->row()->EMPLOYEE_IURAN_JP); ?>" name="editJP">
                  </div>
                </div>
