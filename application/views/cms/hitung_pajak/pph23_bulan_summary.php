      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-6 text-right">
            ...
            <a class="btn btn-sm btn-dark mb-1" data-toggle="tooltip" data-placement="top" title="Harcopy" href="<?= base_url('PPH/Pph23/generateXLSFileLaporPajak?pid=' . $this->input->get('pid') . '&cid=' . $this->input->get('cid')); ?>"><i class="fa fa-envelope"></i> </a> 
          </div>
        </div>
          ...
          <tbody>
            ...
            ?>
                ...
                <tr>
                  ...
                  <td><?= $employee->PPH23_ID; ?></td>
                  <td><?= $employee->PERIOD_MONTH; ?></td> 
