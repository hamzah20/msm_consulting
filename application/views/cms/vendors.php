                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Telkom, STO Palmerah</td>
                      <td>(021) 85669284, 088293372684</td>
                      <td>(021) 85669284</td>
                      <td>telkom.palmerah@gmail.com</td>
                      <td class="text-center">
                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('vendors/detail'); ?>"><i class="fa fa-info-circle"></i></a>
                        <a class="btn btn-sm btn-warning text-white" href="<?php echo base_url('vendors/edit'); ?>" role="button" role="button"><i class="fa fa-edit"></i></a>
