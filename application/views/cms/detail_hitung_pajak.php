    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">      
           <div class="card px-2"> 
            ...
            <a class="btn btn-sm btn-warning col-2 ml-2 mb-3 mt-1 text-white" type="submit" href="<?php echo base_url('company_profile/edit/hitung_pajak?cid=' . $company->row()->COMPANY_ID); ?>">Edit Data</a>
            <hr class="mx-2 mt-0">
