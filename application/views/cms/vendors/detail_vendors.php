...
<!-- End of Header -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">      
           <div class="card px-2">  
                <a class="btn btn-sm btn-warning col-2 ml-2 mb-3 mt-3 text-white" type="submit" href="<?php echo base_url('vendors/edit?vid='.$vendors->row()->VENDOR_ID); ?>">Edit Data</a>
                <hr class="mx-2 mt-0">
				<form method="POST" action="#" class="px-3"> 
                   ...
                   <a class="btn btn-sm btn-secondary col-2 mb-3" href="<?php echo base_url('vendors'); ?>">Kembali</a>
                </form> 
            </div>
