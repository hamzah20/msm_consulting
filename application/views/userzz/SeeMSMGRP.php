...
<section class="content">
    ...
    switch ($_swiUSR014) {
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pull-left">
                            ...
                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR014/msmadd'; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Add';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Tambah';
                            ...
                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcXLSUSR014/expxls'; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Export MSM Group Format/Data';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Export Format/Data MSM Group';
                            } else {
                                echo 'Export Format/Data MSM Group';
                            };
                            ...
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Import MSM Group Data';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Import Data MSM Group';
                            } else {
                                echo 'Import Data MSM Group';
                            };
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="white-space: nowrap">
                                                <?php
                                                if ($_sesFLNGAGE == 'eng') {
                                                    echo 'MSM Group Personnel Name';
                                                } elseif ($_sesFLNGAGE == 'ina') {
                                                    echo 'Nama Personil MSM Group';
                                                } else {
                                                    echo 'Nama Personil MSM Group';
                                                };
                                                ?>
                                        ...
                                        foreach ($_tblCLIENT as $_oRow) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" style="white-space: nowrap; width: 1%">
                                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR014/msmviw/' . $_oRow['FRECNMB'] . '/' . $_oRow['FCODEZZ']; ?>" title="<?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo 'View';
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo 'Lihat';
        ...
        case "msmadd" :
            ?>
            <form action="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR014/msmsve'; ?>" method="POST" class="form-horizontal">
                <?php
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pull-left">
                                &nbsp;
                                &nbsp;
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR014/msmlst'; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                if ($_sesFLNGAGE == 'eng') {
                                    echo 'Cancel';
                                } elseif ($_sesFLNGAGE == 'ina') {
                                    echo 'Batal';
                            ...
                            <div class="col-lg-12">
                                <div>
                                    <label class="sk_label_modification">
                                        <?php
                                        if ($_sesFLNGAGE == 'eng') {
                                            echo 'MSM Group Personnel Sequence Nmb.';
                                        } elseif ($_sesFLNGAGE == 'ina') {
                                            echo 'No. Urut Personil MSM Group';
                                        } else {
                                            echo 'No. Urut Personil MSM Group';
                                        };
        ...
        case "msmsve" :
            ...
            if ($this->session->flashdata('true')) {
                ...
                if ($_sesFLNGAGE == 'eng') {
                    ...
                    echo '}).then(result => {if (result.value) {document.location.href="' . base_url('NocUSERZZ/cfcACTUSR014/msmlst') . '"}});});';
                    echo '</script>';
                } elseif ($_sesFLNGAGE == 'ina') {
                    echo '<script type="text/javascript" src="' . base_url(), 'assets/jquery/js/jquery-3.3.1.min.js' . '"></script>';
                    echo '<link rel="stylesheet" href="' . base_url(), 'assets/sweetalert2/css/sweetalert2.min.css' . '">';
        ...
        case "msmviw" :
            ...
            $_oFJOBLVL = $_tblCLIENT['0']['FJOBLVL'];
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pull-left">
                            ...
                            <a href="<?= base_url(), 'NocUSERZZ/cfcACTUSR014/msmedt/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="Edit" style="background-color: #f0ad4e"><font style="color: #ffffff; font-size: 17px"><i class="fas fa-pencil-alt fa-lg"></i></font></a>

                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR014/msmdel/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" role="button" class="btn btn-default btn-flat <?php
                            if ($_sesFLNGAGE == 'eng') {
                            ...
                            ?>" title="<?php
                               ...
                               ?>" style="background-color: #d9534f; visibility: <?php
                               if ($_oFJOBLVL == '9') {
                                   echo 'hidden';
                               } else {
                                   echo 'visible';
                               }
                               ?>"><font style="color: #ffffff; font-size: 17px"> <i class="far fa-trash-alt fa-fw fa-lg"></i></font></a>
                        </div>
                    </div>
                </div>
                <hr class="sk_hr_modification0">
        ...
        case "msmedt" :
            ...
            $_cmpFCODEZZ = $this->uri->segment(5);
            ?>
            <form action="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR014/msmupd/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pull-left">
                                &nbsp;
                                &nbsp;
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR014/msmviw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                if ($_sesFLNGAGE == 'eng') {
                                    echo 'Cancel';
                                } elseif ($_sesFLNGAGE == 'ina') {
                                    echo 'Batal';
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="_edtFFULNME" class="form-control" value="<?php
                                    if (!empty($_oFFULNME)) {
                                        echo $_oFFULNME;
                                    } else {
                                        echo '';
                                ...
                                <div>
                                    ...
                                    <input type="text" name="_edtFTELPON" class="form-control" value="<?php
                                    if (!empty($_oFTELPON)) {
                                        echo $_oFTELPON;
                                    } else {
                                        echo '';
                                ...
                                <div>
                                    ...
                                    <input type="text" name="_edtFFAXIML" class="form-control" value="<?php
                                    if (!empty($_oFFAXIML)) {
                                        echo $_oFFAXIML;
                                    } else {
                                        echo '';
                                ...
                                <div>
                                    ...
                                    <input type="text" name="_edtFEMAILZ" class="form-control" value="<?php
                                    if (!empty($_oFEMAILZ)) {
                                        echo $_oFEMAILZ;
                                    } else {
                                        echo '';
