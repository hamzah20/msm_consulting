...
<section class="content">
    ...
    switch ($_swiUSR004) {
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pull-left">
                            &nbsp;
                            &nbsp;
                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR004/kppadd'; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Add';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Tambah';
                            ...
                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcXLSUSR004/expxls'; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Export Format/Data KPP (Kantor Pelayanan Pajak)';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Export Format/Data KPP (Kantor Pelayanan Pajak)';
                            } else {
                                echo 'Export Format/Data KPP (Kantor Pelayanan Pajak)';
                            ...
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Import KPP (Kantor Pelayanan Pajak) Data';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Import Data KPP (Kantor Pelayanan Pajak)';
                            } else {
                                echo 'Import Data KPP (Kantor Pelayanan Pajak)';
                            };
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="white-space: nowrap">
                                                <?php
                                                if ($_sesFLNGAGE == 'eng') {
                                                    echo 'Tax Service/Instance Office Name';
                                                } elseif ($_sesFLNGAGE == 'ina') {
                                                    echo 'Nama Kantor Pelayanan Pajak/Instansi';
                                                } else {
                                                    echo 'Nama Kantor Pelayanan Pajak/Instansi';
                                                };
                                                ?>
                                        ...
                                        foreach ($_tblKPPOFF as $_oRow) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="white-space: nowrap; width: 15%">
                                                    ...
                                                    if (!empty($_oRow['FTELPON'])) {
                                                        if (strlen($_oRow['FTELPON']) <= 25) {
                                                            ...
                                                            echo substr($_oRow['FTELPON'], 0, 25) . '...';
                                                        }
                                                    } else {
                                                        echo '...';
                                                    }
                                                ...
                                                <td align="left" style="white-space: nowrap; width: 15%">
                                                    ...
                                                    if (!empty($_oRow['FFAXIML'])) {
                                                        if (strlen($_oRow['FFAXIML']) <= 25) {
                                                            ...
                                                            echo substr($_oRow['FFAXIML'], 0, 25) . '...';
                                                        }
                                                    } else {
                                                        echo '...';
                                                    }
                                                ...
                                                <td align="left" style="white-space: nowrap; width: 10%">
                                                    ...
                                                    if (!empty($_oRow['FEMAILZ'])) {
                                                        if (strlen($_oRow['FEMAILZ']) <= 25) {
                                                            ...
                                                            echo substr($_oRow['FEMAILZ'], 0, 25) . '...';
                                                        }
                                                    } else {
                                                        echo '...';
                                                    }
                                                ...
                                                <td align="center" style="white-space: nowrap; width: 1%">
                                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR004/kppviw/' . $_oRow['FRECNMB'] . '/' . $_oRow['FCODEZZ']; ?>" title="<?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo 'View';
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo 'Lihat';
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pull-left">
                                &nbsp;
                                &nbsp;
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR004/kpplst'; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                if ($_sesFLNGAGE == 'eng') {
                                    echo 'Cancel';
                                } elseif ($_sesFLNGAGE == 'ina') {
                                    echo 'Batal';
        ...
        case "kppsve" :
            ...
            if ($this->session->flashdata('true')) {
                ...
                if ($_sesFLNGAGE == 'eng') {
                    ...
                    echo '}).then(result => {if (result.value) {document.location.href="' . base_url('NocUSERZZ/cfcACTUSR004/kpplst') . '"}});});';
                    echo '</script>';
                } elseif ($_sesFLNGAGE == 'ina') {
                    echo '<script type="text/javascript" src="' . base_url(), 'assets/jquery/js/jquery-3.3.1.min.js' . '"></script>';
                    echo '<link rel="stylesheet" href="' . base_url(), 'assets/sweetalert2/css/sweetalert2.min.css' . '">';
        ...
        case "kppviw" :
            ?>
            <?php
            $_oFRECNMB = $_tblKPPOFF['0']['FRECNMB'];
            $_oFCODEZZ = $_tblKPPOFF['0']['FCODEZZ'];
            $_oFFULNME = $_tblKPPOFF['0']['FFULNME'];
            $_oFSEQNMB = $_tblKPPOFF['0']['FSEQNMB'];
            $_oFADDRES = $_tblKPPOFF['0']['FADDRES'];
            $_oFTELPON = $_tblKPPOFF['0']['FTELPON'];
            $_oFFAXIML = $_tblKPPOFF['0']['FFAXIML'];
            $_oFCATGRY = $_tblKPPOFF['0']['FCATGRY'];
            $_oFEMAILZ = $_tblKPPOFF['0']['FEMAILZ'];
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pull-left">
                            ...
                            <a href="<?= base_url(), 'NocUSERZZ/cfcACTUSR004/kppedt/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="Edit" style="background-color: #f0ad4e"><font style="color: #ffffff; font-size: 17px"><i class="fas fa-pencil-alt fa-lg"></i></font>
                            </a>

                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR004/kppdel/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" role="button" class="btn btn-default btn-flat <?php
                            if ($_sesFLNGAGE == 'eng') {
                        ...
                        <div class="col-lg-12">
                            <div>
                                <label class="sk_label_modification">
                                    <?php
                                    if ($_sesFLNGAGE == 'eng') {
                                        echo 'Kantor Pelayanan Pajak Sequence Nmb';
                                    } elseif ($_sesFLNGAGE == 'ina') {
                                        echo 'No. Urut Kantor Pelayanan Pajak';
                                    } else {
                                        echo 'No. Urut Kantor Pelayanan Pajak';
                                    };
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    ...
                                    <input type="text" id="_viwFCATGRY" name="_viwFCATGRY" class="form-control" autofocus readonly value="<?php
                                    if ($_oFCATGRY == 'kppofc') {
                                        echo 'KPP';
                                    } elseif ($_oFCATGRY == 'client') {
                                        echo 'Klien';
                                    } elseif ($_oFCATGRY == 'vendor') {
                                        echo 'Vendor/Lain-Lain';
                                    } elseif ($_oFCATGRY == 'msmgrp') {
                                        echo 'MSM Group';
                                    }
                                    ?>">
                                </div>
                                <div class="col-lg-2">
                                    ...
                                    <input type="text" name="_viwFSEQNMB" class="form-control" autofocus readonly value="<?php
                                    if (!empty($_oFSEQNMB)) {
                                        echo $_oFSEQNMB;
                                    } else {
                                        echo '...';
                            ...
                            <div>
                                ...
                                <textarea rows="5" type="text" name="_viwFADDRES" class="form-control" autofocus readonly><?php
                            ...
                            <div>
                                ...
                                <input type="text" name="_viwFFAXIML" class="form-control" autofocus readonly value="<?php
                                if (!empty($_oFFAXIML)) {
                                    echo $_oFFAXIML;
                                } else {
                                    echo '...';
        ...
        case "kppedt" :
            ...
            $_cmpFCODEZZ = $this->uri->segment(5);
            ?>
            <form action="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR004/kppupd/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                <div class="well well-sm sk_well_modification0">
                    <div style="height: 20px;">
                        <br>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pull-left">
                                &nbsp;
                                &nbsp;
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR004/kppviw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                if ($_sesFLNGAGE == 'eng') {
                                    echo 'Cancel';
                                } elseif ($_sesFLNGAGE == 'ina') {
                                    echo 'Batal';
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        ...
                                        <input type="text" id="_edxFCATGRY" name="_edxFCATGRY" class="form-control" autofocus readonly value="<?php
                                        if ($_oFCATGRY == 'kppofc') {
                                            echo 'KPP';
                                        } elseif ($_oFCATGRY == 'client') {
                                            echo 'Klien';
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <input type="text" id="_edtFSEQNMB" name="_edtFSEQNMB" class="form-control" autofocus oninvalid="<?php
                                        if ($_sesFLNGAGE == 'eng') {
                                            echo "this.setCustomValidity('Please fill out this field')";
                                        } elseif ($_sesFLNGAGE == 'ina') {
                                            echo "this.setCustomValidity('Silahkan isi kolom ini')";
                                    ...
                                    <div class="col-lg-8">
                                        <label class="label-mins" id="_edtFFULNME">
                                            <?php
                                            if ($_sesFLNGAGE == 'eng') {
                                                echo 'Tax Service Office Name';
                                            } elseif ($_sesFLNGAGE == 'ina') {
                                        ...
                                        <input type="text" name="_edtFFULNME" class="form-control" autofocus required oninvalid="<?php
                                        if ($_sesFLNGAGE == 'eng') {
                                            echo "this.setCustomValidity('Please fill out this field')";
                                        } elseif ($_sesFLNGAGE == 'ina') {
                                            echo "this.setCustomValidity('Silahkan isi kolom ini')";
