    ...
    switch ($_swiUSR009) {
                                        ...
                                        foreach ($_tblC22LST as $_oRow) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" style="white-space: nowrap; width: 10%">
                                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22viw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ ?>" title="<?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo 'View';
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo 'Lihat';
        ...
        case "c22viw":
            ...
            ?> well well-sm sk_well_modification0">
                ...
                $_oCnt = $_queP22HST->num_rows();
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        &nbsp;
                        &nbsp;
                        <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22lst'; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                        if ($_sesFLNGAGE == 'eng') {
                            echo 'Back';
                        } elseif ($_sesFLNGAGE == 'ina') {
                            echo 'Kembali';
                        ...
                        <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22viw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/yer'; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                        if ($_sesFLNGAGE == 'eng') {
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($_queP22HST->result_array() as $_oRow) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" style="white-space: nowrap; width: 1%">
                                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22viw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_oRow['XYEARZZ']; ?>" title="<?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo 'View';
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo 'Lihat';
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pull-left">
                            ...
                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22viw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Back';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Kembali';
                            ...
                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/prdadd/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Tambah Periode/Masa PPh 22';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Tambah Periode/Masa PPh 22';
                            } else {
                                echo 'Tambah Periode/Masa PPh 22';
                                ...
                                <table id="_objINAcXXvid" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="white-space: nowrap; width: 1%">PPh 22 (Terutang)</th>
                                            <th class="text-center" style="white-space: nowrap; width: 1%">#</th>
                                        </tr>
                                    </thead>
                                    <tbody>
            ...
            ?> well well-sm sk_well_modification0">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/prdadd/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_cmpFYEARZZ; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                        if ($_sesFLNGAGE == 'eng') {
                            echo 'Add New PPh 22 Period/Term';
                        } elseif ($_sesFLNGAGE == 'ina') {
                            echo 'Tambah Periode/Masa PPh 22';
                        } else {
                            echo 'Tambah Periode/Masa PPh 22';
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($_queP22HST->result_array() as $_oRow) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" style="white-space: nowrap; width: 1%">
                                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_oRow['FRECNMB'] . '/' . $_oRow['FPROFLE'] . '/' . $_cmpFYEARZZ . '/' . $_oRow['FWRKSTA']; ?>" title="<?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo 'View';
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo 'Lihat';
        ...
        case "prdadd":
            ...
            ?>
            <form action="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/prdsve/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_cmpFYEARZZ; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                <div class="well well-sm sk_well_modification0">
                    <div style="height: 20px;">
                        <br>
                    </div>
        ...
        case "prdsve" :
            ...
            if ($this->session->flashdata('true')) {
                ...
                if ($_sesFLNGAGE == 'eng') {
                    ...
                    echo '}).then(result => {if (result.value) {document.location.href="' . base_url('NocUSERZZ/cfcACTUSR009/c22viw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_cmpFYEARZZ . '') . '"}});});';
                    echo '</script>';
                } elseif ($_sesFLNGAGE == 'ina') {
                    echo '<script type="text/javascript" src="' . base_url(), 'assets/jquery/js/jquery-3.3.1.min.js' . '"></script>';
                    echo '<link rel="stylesheet" href="' . base_url(), 'assets/sweetalert2/css/sweetalert2.min.css' . '">';
        ...
        case "c22smr" :
            ...
            $_oFFULNME = $_tblC22SMR['0']['FFULNME'];

            $this->db->select('*');
            $this->db->from('ttaxhst');
            $this->db->where('FRECNMB', $_hstFRECNMB);
            $this->db->where('FFLGTAX', 'hstp22');
            $_queC22SMR = $this->db->get();

            foreach ($_queC22SMR->result_array() as $_oRow) {
            ...
            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pull-left">
                                &nbsp;
                                &nbsp;
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22viw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                if ($_sesFLNGAGE == 'eng') {
                                    echo 'Back';
                                } elseif ($_sesFLNGAGE == 'ina') {
                                    echo 'Kembali';
                                ...
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcXLSUSR009/c22smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/exprps'; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                if ($_sesFLNGAGE == 'eng') {
                                    echo 'Download (Unduh) Laporan PPh 22 (Terutang)';
                                } elseif ($_sesFLNGAGE == 'ina') {
                                    echo 'Download (Unduh) Laporan PPh 22 (Terutang)';
                                } else {
                                    echo 'Download (Unduh) Laporan PPh 22 (Terutang)';
                                ...
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/sndeml' . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                if ($_sesFLNGAGE == 'eng') {
                                ...
                                ?> href="<?php
                                    if (!empty($_oFAPRFLG)) {
                                        if ((strtolower(trim($_oFAPRFLG)) == 'n') || (strtolower(trim($_oFAPRFLG)) !== 'y')) {
                                            ...
                                            echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22cor/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA . '/' . $_oFREVISI;
                                        }
                                    } else {
                                        echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22cor/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA . '/' . $_oFREVISI;
                                    }
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="sk_table_modification2 table-responsive"> 
                                            <table id="" class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center" style="white-space: nowrap; width: 97%">Keterangan</th>
                                                        <th class="text-center" style="white-space: nowrap; width: 1%">DPP (Dasar Pengenaan Pajak)</th>
                                                ...
                                                <tbody>
                                                    <?php
                                                    $this->db->select('COUNT(*) AS XCOUNTZ, SUM(FMSMDPB) AS XPJKDPP, SUM(FMSMNML) AS XPJKNML');
                                                    $this->db->from('ttaxhst');
                                                    $this->db->where(array(
                                                    ...
                                                    $this->db->where('FRECNMB', $_hstFRECNMB);
                                                    $this->db->update('ttaxhst', $_updP22HST);

                                                    $this->db->select('*, SUM(FMSMDPB) as XMSMDPB, SUM(FMSMNML) as XMSMNML, , tkjstor.FLABELZ as XLABELZ');
                                                    $this->db->from('ttaxhst');
                                                    ...
                                                    foreach ($_quePROFLE->result_array() as $_oRow) {
                                                        ...
                                                        <tr style="color: #000000; background-color: #ffffff">
                                                            ...
                                                            <td align="right">
                                                                <?php
                                                                if (!empty($_oRow['XMSMDPB'])) {
                                                                    echo number_format($_oRow['XMSMDPB']);
                                                                } else {
                                                                    echo number_format('0');
                                                                };
                                                                ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="pull-left">
                                &nbsp;
                                &nbsp;  
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcXLSUSR009/c22smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/expfrd'; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                if ($_sesFLNGAGE == 'eng') {
                                    echo 'Export PPh 22 Format/Data';
                                } elseif ($_sesFLNGAGE == 'ina') {
                                    echo 'Export Format/Data PPh 22';
                                } else {
                                    echo 'Export Format/Data PPh 22';
                                };
                                ...
                                ?> href="<?php
                                    if (!empty($_oFAPRFLG)) {
                                        if (strtolower(trim($_oFAPRFLG)) == 'y') {
                                            ...
                                            echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22imp/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . '_impFUSERZZ' . '/' . $_oFPERIOD . '/' . $_oFREVISI;
                                        } else {
                                            echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22imp/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . '_impFUSERZZ' . '/' . $_oFPERIOD . '/' . $_oFREVISI;
                                        }
                                    } else {
                                ...
                                <div class="sk_table_modification2 table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" style="width: 100%">
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="text-center" style="white-space: nowrap">No.</th>
                                                <th class="text-center" style="white-space: nowrap">Tgl. Invoice</th>
                                                <th class="text-center" style="white-space: nowrap">Tgl. Bayar</th>
                                                <th class="text-center" style="white-space: nowrap">No. Invoice</th>
                                                <th class="text-center" style="white-space: nowrap">Nama Lawan Transaksi</th>
                                                <th class="text-center" style="white-space: nowrap">DPP</th>
                                                <th class="text-center" style="white-space: nowrap">Tarif Pajak</th>
                                                <th class="text-center" style="white-space: nowrap">PPh</th>
                                                <th class="text-center" style="white-space: nowrap">#</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            foreach ($_queC22SMR->result_array() as $_oRow) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" style="white-space: nowrap">
                                                        <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/viw/' . $_oRow['FRECNMB']; ?>" title="<?php
                                                        if ($_sesFLNGAGE == 'eng') {
                                                            echo 'View';
                                                        } elseif ($_sesFLNGAGE == 'ina') {
                                                            echo 'Lihat';
                ...
                ?>">
                    <form action="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/sve'; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">                                        
                        <div style="height: 20px;">
                            <br>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="_finFINVDPP" class="form-control" autofocus required oninvalid="<?php
                                                if ($_sesFLNGAGE == 'eng') {
                                                    echo "this.setCustomValidity('Please fill out this field')";
                                                } elseif ($_sesFLNGAGE == 'ina') {
                                                    echo "this.setCustomValidity('Silahkan isi kolom ini')";
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="_finFINVPPN" class="form-control" autofocus required oninvalid="<?php
                                                if ($_sesFLNGAGE == 'eng') {
                                                    echo "this.setCustomValidity('Please fill out this field')";
                                                } elseif ($_sesFLNGAGE == 'ina') {
                                                    echo "this.setCustomValidity('Silahkan isi kolom ini')";
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="_finFINVDPN" class="form-control" autofocus required oninvalid="<?php
                                                if ($_sesFLNGAGE == 'eng') {
                                                    echo "this.setCustomValidity('Please fill out this field')";
                                                } elseif ($_sesFLNGAGE == 'ina') {
                                                    echo "this.setCustomValidity('Silahkan isi kolom ini')";
                                            ...
                                            <div>
                                                ...
                                                <div class="input-group date">
                                                    <input type="text" name="_finFFKTDTE" class="form-control" placeholder="" required oninvalid="<?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo "this.setCustomValidity('Please fill out this field')";
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo "this.setCustomValidity('Silahkan isi kolom ini')";
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="_finFFKTNMB" class="form-control" autofocus required oninvalid="<?php
                                                if ($_sesFLNGAGE == 'eng') {
                                                    echo "this.setCustomValidity('Please fill out this field')";
                                                } elseif ($_sesFLNGAGE == 'ina') {
                                                    echo "this.setCustomValidity('Silahkan isi kolom ini')";
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="_finFFKTDPP" class="form-control" autofocus required oninvalid="<?php
                                                if ($_sesFLNGAGE == 'eng') {
                                                    echo "this.setCustomValidity('Please fill out this field')";
                                                } elseif ($_sesFLNGAGE == 'ina') {
                                                    echo "this.setCustomValidity('Silahkan isi kolom ini')";
                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                ...
                                                <input type="text" name="_finFFKTPPN" class="form-control" autofocus required oninvalid="<?php
                                                if ($_sesFLNGAGE == 'eng') {
                                                    echo "this.setCustomValidity('Please fill out this field')";
                                                } elseif ($_sesFLNGAGE == 'ina') {
                                                    echo "this.setCustomValidity('Silahkan isi kolom ini')";
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="_finFFKTDPN" class="form-control" autofocus required oninvalid="<?php
                                                if ($_sesFLNGAGE == 'eng') {
                                                    echo "this.setCustomValidity('Please fill out this field')";
                                                } elseif ($_sesFLNGAGE == 'ina') {
                                                    echo "this.setCustomValidity('Silahkan isi kolom ini')";
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="_finFBYRNML" class="form-control" autofocus required value="<?php
                                                if (!empty($_oFBYRNML)) {
                                                    echo $_oFBYRNML;
                                                } else {
                                                    echo '';
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="_finFBYRDSC" class="form-control" autofocus required value="<?php
                                                if (!empty($_oFBYRDSC)) {
                                                    echo $_oFBYRDSC;
                                                } else {
                                                    echo '';
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="_finFMSMDPB" class="form-control" autofocus required oninvalid="<?php
                                                if ($_sesFLNGAGE == 'eng') {
                                                    echo "this.setCustomValidity('Please fill out this field')";
                                                } elseif ($_sesFLNGAGE == 'ina') {
                                                    echo "this.setCustomValidity('Silahkan isi kolom ini')";
                ...
                ?>"><?php
                         $_oFFULNME = $_tblC22EDT['0']['FFULNME'];
                         $_oFNPWPZZ = $_tblC22EDT['0']['FNPWPZZ'];
                         $_oFPJKADR = $_tblC22EDT['0']['FPJKADR'];
                         $_oFPJKDSC = $_tblC22EDT['0']['FPJKDSC'];
                         $_oFINVDTE = $_tblC22EDT['0']['FINVDTE'];
                         $_oFINVNMB = $_tblC22EDT['0']['FINVNMB'];
                         $_oFINVDPP = $_tblC22EDT['0']['FINVDPP'];
                         $_oFINVPPN = $_tblC22EDT['0']['FINVPPN'];
                         $_oFINVDPN = $_tblC22EDT['0']['FINVDPN'];
                         $_oFFKTDTE = $_tblC22EDT['0']['FFKTDTE'];
                         $_oFFKTNMB = $_tblC22EDT['0']['FFKTNMB'];
                         $_oFFKTDPP = $_tblC22EDT['0']['FFKTDPP'];
                         $_oFFKTPPN = $_tblC22EDT['0']['FFKTPPN'];
                         $_oFFKTDPN = $_tblC22EDT['0']['FFKTDPN'];
                         $_oFBYRDTE = $_tblC22EDT['0']['FBYRDTE'];
                         $_oFBYRNML = $_tblC22EDT['0']['FBYRNML'];
                         $_oFBYRDSC = $_tblC22EDT['0']['FBYRDSC'];
                         $_oFMSMDPB = $_tblC22EDT['0']['FMSMDPB'];
                         $_oFMSMDPJ = $_tblC22EDT['0']['FMSMDPJ'];
                         $_oFKJSZZZ = $_tblC22EDT['0']['FKJSZZZ'];
                         $_oFMSMTRF = $_tblC22EDT['0']['FMSMTRF'];
                         $_oFMSMNML = $_tblC22EDT['0']['FMSMNML'];
                         $_oFPJKDOC = $_tblC22EDT['0']['FPJKDOC'];
                         ?>
                    <form action="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/upd/' . $_varXRECNMB; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">                                                            
                        <div style="height: 20px;">
                            <br>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="pull-left">
                                    &nbsp;
                                    &nbsp;
                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/viw/' . $_varXRECNMB; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                    if ($_sesFLNGAGE == 'eng') {
                                        echo 'Cancel';
                                    } elseif ($_sesFLNGAGE == 'ina') {
                                        echo 'Batal';
                ...
                ?>"><?php
                         $_oFFULNME = $_tblC22VIW['0']['FFULNME'];
                         $_oFNPWPZZ = $_tblC22VIW['0']['FNPWPZZ'];
                         $_oFPJKADR = $_tblC22VIW['0']['FPJKADR'];
                         $_oFPJKDSC = $_tblC22VIW['0']['FPJKDSC'];
                         $_oFINVDTE = $_tblC22VIW['0']['FINVDTE'];
                         $_oFINVNMB = $_tblC22VIW['0']['FINVNMB'];
                         $_oFINVDPP = $_tblC22VIW['0']['FINVDPP'];
                         $_oFINVPPN = $_tblC22VIW['0']['FINVPPN'];
                         $_oFINVDPN = $_tblC22VIW['0']['FINVDPN'];
                         $_oFFKTDTE = $_tblC22VIW['0']['FFKTDTE'];
                         $_oFFKTNMB = $_tblC22VIW['0']['FFKTNMB'];
                         $_oFFKTDPP = $_tblC22VIW['0']['FFKTDPP'];
                         $_oFFKTPPN = $_tblC22VIW['0']['FFKTPPN'];
                         $_oFFKTDPN = $_tblC22VIW['0']['FFKTDPN'];
                         $_oFBYRDTE = $_tblC22VIW['0']['FBYRDTE'];
                         $_oFBYRNML = $_tblC22VIW['0']['FBYRNML'];
                         $_oFBYRDSC = $_tblC22VIW['0']['FBYRDSC'];
                         $_oFMSMDPB = $_tblC22VIW['0']['FMSMDPB'];
                         $_oFMSMDPJ = $_tblC22VIW['0']['FMSMDPJ'];
                         $_oFKJSZZZ = $_tblC22VIW['0']['FKJSZZZ'];
                         $_oFMSMTRF = $_tblC22VIW['0']['FMSMTRF'];
                         $_oFMSMNML = $_tblC22VIW['0']['FMSMNML'];
                         $_oFPJKDOC = $_tblC22VIW['0']['FPJKDOC'];
                         ?>
                    <div style="height: 20px;">
                        <br>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pull-left">
                                ...
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/edt/' . $_varXRECNMB; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="Edit" style="background-color: #f0ad4e"><font style="color: #ffffff; font-size: 17px"><i class="fas fa-pencil-alt fa-lg"></i></font></a>

                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/del/' . $_varXRECNMB; ?>" role="button" class="btn btn-default btn-flat sk_button_modification <?php
                                if ($_sesFLNGAGE == 'eng') {
        ...
        case "c22imp" :
            ...
            $_oChk = '';
            ?>
            <form action="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c22imp/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . '_preFPROGRE' . '/' . $_varFPERIOD . '/' . $_varFREVISI; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                <div class="well well-sm sk_well_modification0">
                    <div style="height: 20px;">
                        <br>
                    </div>
                                                ...
                                                if ($_oSeq > 2) {
                                                    ...
                                                    if (strlen(trim($_oXCHKALL)) > 25) {
                                                        ...
                                                        if ($_queP22HST->num_rows() > 0) {
                                                            ...
                                                            $this->db->insert('ttaxhst', $_addP22HST);
                                                        }
                                                    }
                                                }
                                            }
                                            if ($_sesFCATGRY == 'client') {
                                                redirect('NocUSERZZ/cfcACTUSR009/c222mr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ);
                                            } else {
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($_queP22HST->result_array() as $_oRow) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" style="white-space: nowrap; width: 1%">
                                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c222mr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_oRow['FRECNMB'] . '/' . $_oRow['FPROFLE'] . '/' . substr($_oRow['FPERIOD'], 0, 4) . '/' . $_oRow['FWRKSTA']; ?>" title="<?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo 'View';
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo 'Lihat';
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pull-left">
                                &nbsp;
                                &nbsp;
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR009/c222st'; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                if ($_sesFLNGAGE == 'eng') {
                                    echo 'Back';
                                } elseif ($_sesFLNGAGE == 'ina') {
                                    echo 'Kembali';
                                ...
                                ?> href="<?php
                                    if (!empty($_oFAPRFLG)) {
                                        if (strtolower(trim($_oFAPRFLG)) == 'y') {
                                            ...
                                            echo base_url(), 'NocUSERZZ/cfcACTUSR009/c222pr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA . '/' . $_oFREVISI;
                                        }
                                    } else {
                                        echo base_url(), 'NocUSERZZ/cfcACTUSR009/c222pr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA . '/' . $_oFREVISI;
                                    }
                                    ...
                                    <table class="table table-striped table-bordered table-hover" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" style="white-space: nowrap; width: 1%">No. Invoice</th>
        ...
        case "c22eml" :
            ...
            if ($this->session->flashdata('true')) {
                ...
                if ($_sesFLNGAGE == 'eng') {
                    ...
                    echo '<script> $( document ).ready(function() {';
                    echo 'swal.fire({ title: "<h3>Success !</h3>", html: "<h4>Record Inserted</h4>", type: "success", width: "400px",';
                    echo '}).then(result => {if (result.value) {document.location.href="' . base_url('NocUSERZZ/cfcACTUSR009/c22smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA . '') . '"}});});';
                    echo '</script>';
                } elseif ($_sesFLNGAGE == 'ina') {
                    echo '<script type="text/javascript" src="' . base_url(), 'assets/jquery/js/jquery-3.3.1.min.js' . '"></script>';
                    echo '<link rel="stylesheet" href="' . base_url(), 'assets/sweetalert2/css/sweetalert2.min.css' . '">';
