    ...
    switch ($_swiUSR011) {
                                        ...
                                        foreach ($_tblC42LST as $_oRow) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" style="white-space: nowrap; width: 10%">
                                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42viw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ ?>" title="<?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo 'View';
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo 'Lihat';
        ...
        case "c42viw":
            ...
            ?> well well-sm sk_well_modification0">
                ...
                $_queP42HST = $this->db->get();

                $_oCnt = $_queP42HST->num_rows();
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        &nbsp;
                        &nbsp;
                        <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42lst'; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                        if ($_sesFLNGAGE == 'eng') {
                            echo 'Back';
                        } elseif ($_sesFLNGAGE == 'ina') {
                            echo 'Kembali';
                        ...
                        <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42viw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/yer'; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                        if ($_sesFLNGAGE == 'eng') {
                            ...
                            <div class="sk_table_modification2 table-responsive">
                                <table id = "_objINAcXXvit" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $_oSeq = 0;
                                        foreach ($_queP42HST->result_array() as $_oRow) {
                                            $_oSeq ++;
                                            ?>
                                            <tr>
                                                ...
                                                <td align="center" style="white-space: nowrap; width: 1%">
                                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42viw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_oRow['XYEARZZ'] ?>" title="<?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo 'View';
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo 'Lihat';
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pull-left">
                            ...
                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42viw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Back';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Kembali';
                            ...
                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/prdadd/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Tambah Periode/Masa PPh 4(2)';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Tambah Periode/Masa PPh 4(2)';
                            } else {
                                echo 'Tambah Periode/Masa PPh 4(2)';
            ...
            ?> well well-sm sk_well_modification0">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/prdadd/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_cmpFYEARZZ; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                        if ($_sesFLNGAGE == 'eng') {
                            echo 'Add New PPh 4(2_ Period/Term';
                        } elseif ($_sesFLNGAGE == 'ina') {
                            echo 'Tambah Periode/Masa PPh 4(2)';
                        } else {
                            echo 'Tambah Periode/Masa PPh 4(2)';
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($_queP42HST->result_array() as $_oRow) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" style="white-space: nowrap; width: 1%">
                                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_oRow['FRECNMB'] . '/' . $_oRow['FPROFLE'] . '/' . $_cmpFYEARZZ . '/' . $_oRow['FWRKSTA']; ?>" title="<?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo 'View';
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo 'Lihat';
        ...
        case "prdadd":
            ...
            ?>
            <form action="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/prdsve/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_cmpFYEARZZ; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                <div class="well well-sm sk_well_modification0">
                    <div style="height: 20px;">
                        <br>
                    </div>
        ...
        case "prdsve" :
            ...
            if ($this->session->flashdata('true')) {
                ...
                if ($_sesFLNGAGE == 'eng') {
                    ...
                    echo '}).then(result => {if (result.value) {document.location.href="' . base_url('NocUSERZZ/cfcACTUSR011/c42viw/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_cmpFYEARZZ . '') . '"}});});';
                    echo '</script>';
                } elseif ($_sesFLNGAGE == 'ina') {
                    echo '<script type="text/javascript" src="' . base_url(), 'assets/jquery/js/jquery-3.3.1.min.js' . '"></script>';
                    echo '<link rel="stylesheet" href="' . base_url(), 'assets/sweetalert2/css/sweetalert2.min.css' . '">';
        ...
        case "c42smr" :
            ...
            $_oFFULNME = $_tblC42SMR['0']['FFULNME'];
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pull-left">
                            ...
                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcXLSUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/expxl4'; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Download (Unduh) Laporan PPh 4(2) (Terutang)';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Download (Unduh) Laporan PPh 4(2) (Terutang)';
                            } else {
                                echo 'Download (Unduh) Laporan PPh 4(2) (Terutang)';
                            ...
                            <a href="<?php
                            echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/sndeml' . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA;
                            ;
                            ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                               if ($_sesFLNGAGE == 'eng') {
                            ...
                            ?> href="<?php
                                if (!empty($_oFAPRFLG)) {
                                    if ((strtolower(trim($_oFAPRFLG)) == 'n') || (strtolower(trim($_oFAPRFLG)) !== 'y')) {
                                        ...
                                        echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42cor/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA . '/' . $_oFREVISI;
                                    }
                                } else {
                                    echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42cor/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA . '/' . $_oFREVISI;
                                }
                                    ...
                                    <div class="sk_table_modification2 table-responsive"> 
                                        <table id="" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                $this->db->where('FRECNMB', $_hstFRECNMB);
                                                $this->db->update('ttaxhst', $_updP42HST);
            ...
            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pull-left">
                                &nbsp;
                                &nbsp;  
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcXLSUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/expfrd'; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                if ($_sesFLNGAGE == 'eng') {
                                    echo 'Export Format PPh 4(2)';
                                } elseif ($_sesFLNGAGE == 'ina') {
                                    echo 'Export Format/Data PPh 4(2)';
                                } else {
                                    echo 'Export Format/Data PPh 4(2)';
                                };
                                ...
                                ?> href="<?php
                                    if (!empty($_oFAPRFLG)) {
                                        if (strtolower(trim($_oFAPRFLG)) == 'y') {
                                            ...
                                            echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42imp/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . '_impFUSERZZ' . '/' . $_oFPERIOD . '/' . $_oFREVISI;
                                        } else {
                                            echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42imp/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . '_impFUSERZZ' . '/' . $_oFPERIOD . '/' . $_oFREVISI;
                                        }
                                    } else {
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($_queC21SMR->result_array() as $_oRow) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/viw/' . $_oRow['FRECNMB']; ?>" title="<?php
                                                        if ($_sesFLNGAGE == 'eng') {
                                                            echo 'View';
                                                        } elseif ($_sesFLNGAGE == 'ina') {
                                                            echo 'Lihat';
                ...
                ?>">
                    <form action="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/sve'; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <div style="height: 20px;">
                            <br>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="pull-left">
                                    &nbsp;
                                    &nbsp;
                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                    if ($_sesFLNGAGE == 'eng') {
                                        echo 'Cancel';
                                    } elseif ($_sesFLNGAGE == 'ina') {
                                        echo 'Batal';
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div>
                                                ...
                                                <label class="sk_label_modification">
                                                    <?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo 'PPh 4(2) Document';
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo 'Dokumen PPh 4(2)';
                                                    } else {
                                                        echo 'Dokumen PPh 4(2)';
                                                    };
                                                    ?>&nbsp;:
                ...
                ?>"><?php
                         $_oFINVDTE = $_tblC42EDT['0']['FINVDTE'];
                         $_oFBYRDTE = $_tblC42EDT['0']['FBYRDTE'];
                         $_oFINVNMB = $_tblC42EDT['0']['FINVNMB'];
                         $_oFFULNME = $_tblC42EDT['0']['FFULNME'];
                         $_oFPJKADR = $_tblC42EDT['0']['FPJKADR'];
                         $_oFNPWPZZ = $_tblC42EDT['0']['FNPWPZZ'];
                         $_oFPJKDSC = $_tblC42EDT['0']['FPJKDSC'];
                         $_oFMSMDPJ = $_tblC42EDT['0']['FMSMDPJ'];
                         $_oFMSMTRF = $_tblC42EDT['0']['FMSMTRF'];
                         $_oFPJKDOC = $_tblC42EDT['0']['FPJKDOC'];
                         $_oFMSMNML = $_tblC42EDT['0']['FMSMNML'];
                         $_oFKJSZZZ = $_tblC42EDT['0']['FKJSZZZ'];
                         ?>
                    <form action="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/upd/' . $_varXRECNMB; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">                                                            
                        <div style="height: 20px;">
                            <br>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="pull-left">
                                    &nbsp;
                                    &nbsp;
                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/viw/' . $_varXRECNMB; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                                    if ($_sesFLNGAGE == 'eng') {
                                        echo 'Cancel';
                                    } elseif ($_sesFLNGAGE == 'ina') {
                                        echo 'Batal';
                ...
                ?>"><?php
                         $_oFINVDTE = $_tblC42VIW['0']['FINVDTE'];
                         $_oFBYRDTE = $_tblC42VIW['0']['FBYRDTE'];
                         $_oFINVNMB = $_tblC42VIW['0']['FINVNMB'];
                         $_oFFULNME = $_tblC42VIW['0']['FFULNME'];
                         $_oFPJKADR = $_tblC42VIW['0']['FPJKADR'];
                         $_oFNPWPZZ = $_tblC42VIW['0']['FNPWPZZ'];
                         $_oFPJKDSC = $_tblC42VIW['0']['FPJKDSC'];
                         $_oFMSMDPJ = $_tblC42VIW['0']['FMSMDPJ'];
                         $_oFMSMTRF = $_tblC42VIW['0']['FMSMTRF'];
                         $_oFPJKDOC = $_tblC42VIW['0']['FPJKDOC'];
                         $_oFMSMNML = $_tblC42VIW['0']['FMSMNML'];
                         $_oFKJSZZZ = $_tblC42VIW['0']['FKJSZZZ'];
                         ?>
                    <div style="height: 20px;">
                        <br>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pull-left">
                                ...
                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/edt/' . $_varXRECNMB; ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="Edit" style="background-color: #f0ad4e"><font style="color: #ffffff; font-size: 17px"><i class="fas fa-pencil-alt fa-lg"></i></font></a>

                                <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/del/' . $_varXRECNMB; ?>" role="button" class="btn btn-default btn-flat sk_button_modification <?php
                                if ($_sesFLNGAGE == 'eng') {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="hidden">
                                            ...
                                            <input type="text" name="_finFP42STA" class="form-control" autofocus readonly oninvalid="<?php
                                            if ($_sesFLNGAGE == 'eng') {
                                                echo "this.setCustomValidity('Please fill out this field')";
                                            } elseif ($_sesFLNGAGE == 'ina') {
                                                echo "this.setCustomValidity('Silahkan isi kolom ini')";
        ...
        case "c42imp" :
            ...
            $_oChk = '';
            ?>
            <form action="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42imp/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . '_preFPROGRE' . '/' . $_varFPERIOD . '/' . $_varFREVISI; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                <div class="well well-sm sk_well_modification0">
                    <div style="height: 20px;">
                        <br>
                    </div>
                                    ...
                                    <div class="well" style="background-color: #ffffff">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                ?>" href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c42imp/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . '_impFPROGRE' . '/' . $_varFPERIOD . '/' . $_varFREVISI . '/' . $KATAKPEYANG; ?>" role = "button" title="<?php
                                                   if ($_sesFLNGAGE == 'eng') {
                                                ...
                                                if ($_oDsb == 'Y1') {
                                                    ...
                                                    echo '&ensp;Status Proses PPh 4(2) : <font style="color: #ff0000">Terkendala</font>, karena di data klien, isi kolom periode beda';
                                                } elseif ($_oDsb == 'N') {
                                                    echo '&ensp;Status Proses PPh 4(2) : <font style="color: #ff0000">Siap</font>, data yang sudah <font style="color: #ff0000">valid</font> bisa dimasukkan ke database';
                                                }
                                                ?>
                                            </div>
                                        </div>
                                        ...
                                        if (!empty($_oSeg)) {
                                            ...
                                            if ($_sesFCATGRY == 'client') {
                                                redirect('NocUSERZZ/cfcACTUSR011/c422mr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ);
                                            } else {
                                                redirect('NocUSERZZ/cfcACTUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ);
                                            }
                                        }
                                        ?>
                                    </div>
                                        ...
                                        foreach ($_queP21HST->result_array() as $_oRow) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" style="white-space: nowrap; width: 1%">
                                                    ...
                                                    ?>
                                                    <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c422mr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_oRow['FRECNMB'] . '/' . $_oRow['FPROFLE'] . '/' . substr($_oRow['FPERIOD'], 0, 4) . '/' . $_oRow['FWRKSTA'] . '/' . $_oXREVISI; ?>" title="<?php
                                                    if ($_sesFLNGAGE == 'eng') {
                                                        echo 'View';
                                                    } elseif ($_sesFLNGAGE == 'ina') {
                                                        echo 'Lihat';
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pull-left">
                            &nbsp;
                            &nbsp;
                            <a href="<?php echo base_url(), 'NocUSERZZ/cfcACTUSR011/c422st'; ?>" role = "button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                            if ($_sesFLNGAGE == 'eng') {
                                echo 'Back';
                            } elseif ($_sesFLNGAGE == 'ina') {
                                echo 'Kembali';
                            ...
                            ?>" role="button" class="btn btn-default btn-flat sk_button_modification" title="<?php
                               if ($_sesFLNGAGE == 'eng') {
                                   echo 'Ringkasan Aktivitas PajakXXX';
                               } elseif ($_sesFLNGAGE == 'ina') {
                                   echo 'Ringkasan Aktivitas Pajak000';
                               } else {
                                   echo 'Ringkasan Aktivitas Pajak123';
                               };
                               ?>" style="background-color: #23c9b3">
                                <font style="color: #ffffff; font-size: 17px"><i class="fas fa-paperclip fa-lg"></i></font>
                            </a>
                            ...
                            ?> href="<?php
                                if (!empty($_oFAPRFLG)) {
                                    if (strtolower(trim($_oFAPRFLG)) == 'y') {
                                        ...
                                        echo base_url(), 'NocUSERZZ/cfcACTUSR011/c422pr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA . '/' . $_oFREVISI;
                                    }
                                } else {
                                    echo base_url(), 'NocUSERZZ/cfcACTUSR011/c422pr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA . '/' . $_oFREVISI;
                                }
        ...
        case "c42eml" :
            ...
            if ($this->session->flashdata('true')) {
                ...
                if ($_sesFLNGAGE == 'eng') {
                    ...
                    echo '<script> $( document ).ready(function() {';
                    echo 'swal.fire({ title: "<h3>Success !</h3>", html: "<h4>Record Inserted</h4>", type: "success", width: "400px",';
                    echo '}).then(result => {if (result.value) {document.location.href="' . base_url('NocUSERZZ/cfcACTUSR011/c42smr/' . $_cmpFRECNMB . '/' . $_cmpFCODEZZ . '/' . $_hstFRECNMB . '/' . $_hstFCODEZZ . '/' . $_cmpFYEARZZ . '/' . $_cmpFWRKSTA . '') . '"}});});';
                    echo '</script>';
                } elseif ($_sesFLNGAGE == 'ina') {
                    echo '<script type="text/javascript" src="' . base_url(), 'assets/jquery/js/jquery-3.3.1.min.js' . '"></script>';
                    echo '<link rel="stylesheet" href="' . base_url(), 'assets/sweetalert2/css/sweetalert2.min.css' . '">';
